...
# ablation experiments for code structure encoder
class CodeGNNDualFcInfo_Gnn:
    def __init__(self, config):

        # init params
        config['modeltype'] = 'codegnndualfcinfo_gnn'
    ...
    def create_model(self):
        ...
        met_input = Input(shape=(self.metlen,))  # (None,17)input_6 新增method
        ...
        context = concatenate([scontext, tcontext, decout, mcontext])  # (None, 13, 768)
